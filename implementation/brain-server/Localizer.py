...
class Localizer:
    ...
    def updateParticles(self):
        ...
        try:
            ...
            print(f"Error in `updateParticles`: {e}")
            return None, None
    ...
    def _resampleAndMoveParticles(self, mean_x, mean_y):
        ...
        try:
            ...
            print(f"Error in `_resampleAndMoveParticles`: {e}")
    ...
    def _getColorMask(self, image, color):
        ...
        try:
            ...
            print(f"Error in `_getColorMask`: {e}")
            return None
    ...
    def _getColorBounds(self, color):
        ...
        try:
            ...
            print(f"Error in `_getColorBounds`: {e}")
            return None, None
    ...
    def _calculateWeight(self, x, y, mean, cov):
        ...
        try:
            ...
            print(f"Error in `_calculateWeight`: {e}")
            return 0
    ...
    def _normalizeWeights(self):
        ...
        try:
            ...
            print(f"Error in `_normalizeWeights`: {e}")
