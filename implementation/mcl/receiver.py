...
async def websocket_receiver(message_bus):
    try:
        ...
        async with connect("ws://localhost:8080") as ws:
            ...
            await ws.send(json.dumps({"clientType": "Planner", "messageType": "PlannerConnections",}))
...
def initializeSpheros(spheros, outgoing_queue):
    send_message_to_server(outgoing_queue, "Planner", "PlannerFeedback", "Initialized")
